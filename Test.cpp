...
TEST_CASE("Illegal Digits") {
    ...
    CHECK_THROWS(snowman(11111110)); //no zeros allowd
        ...
        //bigger than the digit limit
    CHECK_THROWS(snowman(51111111)); //no zeros allowd
    CHECK_THROWS(snowman(15111111)); //no zeros allowd
    CHECK_THROWS(snowman(11511111)); //no zeros allowd
    CHECK_THROWS(snowman(11151111)); //no zeros allowd
    CHECK_THROWS(snowman(11115111)); //no zeros allowd
    CHECK_THROWS(snowman(11111511)); //no zeros allowd
